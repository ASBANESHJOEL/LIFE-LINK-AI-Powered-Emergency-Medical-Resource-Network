    ...
    <div className="min-h-screen bg-[#f6f9fc] text-slate-900 flex flex-col">
      ...
      <div className="flex flex-1">
        <aside className="hidden md:flex w-64 shrink-0 flex-col border-r border-slate-200/80 bg-white px-3 py-5">
          ...
          <div className="mt-auto border-t border-slate-100 pt-4"><div className="rounded-xl border border-blue-100 bg-blue-50/70 p-3"><div className="flex items-center gap-2 text-xs font-bold text-[#0067B8]"><ShieldCheck aria-hidden="true" />Secure workspace</div><p className="mt-1.5 text-[11px] leading-relaxed text-slate-600">Authorized network operations workspace.</p></div></div>
        </aside>
