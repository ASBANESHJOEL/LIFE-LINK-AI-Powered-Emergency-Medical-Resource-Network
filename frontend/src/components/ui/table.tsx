...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={twMerge(clsx('bg-slate-900/90 border-b border-slate-800', className))} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={twMerge(
      clsx('h-11 px-4 text-left align-middle text-xs font-semibold text-slate-400 uppercase tracking-wider', className)
    )}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={twMerge(clsx('p-4 align-middle text-slate-200', className))} {...props} />
));
